...
const Billing: React.FC<{ billingDetails?: any }> = ({
  ...
  return (
    <section id="product" className="justify-center" /* className={layout.sectionReverse} */
    >
      ...
      <div className={layout.sectionInfo}>
        <h2 className={`${styles.heading2} text-center `}>
          {billingDetails.title || "Smart E-Labels"}
        </h2>

        <div className={`${styles.flexCenter} justify-between flex-wrap items-center`} /* className={`${layout.sectionImg}`} */>
